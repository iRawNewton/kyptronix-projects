...
class QuestionDev extends StatefulWidget {
  const QuestionDev({super.key, required this.id});
  final String id;

  @override
  State<QuestionDev> createState() => _QuestionDevState();
}

class _QuestionDevState extends State<QuestionDev> {
  dynamic data1;
  dynamic data2;
